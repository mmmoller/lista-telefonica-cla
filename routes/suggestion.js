...
var calcRating = require('../functions/calcRating.js')
				...
				Infosys.findOne({}, function (err, infosys){
					...
					if (infosys){
						...
						for (var i = 0; i < suggestion.length; i++){
							suggestion[i] = suggestion[i].toJSON()
							suggestion[i]["allUsersRating"] = calcRating(false, suggestion[i], ownUser);
							suggestion[i]["friendsRating"] = calcRating(true, suggestion[i], ownUser);
							//console.log(suggestionWithRating[i]._id)
							//console.log(suggestionWithRating[i].allUsersRating)
							//console.log("with: " + suggestionWithRating[i])
						}*/
